...
export default function Navbar() {
  ...
  return (
    <>
      <div className="bg-blue-600 text-white text-center py-1 text-sm">Free delivery on orders above $50</div>
      <Header className="bg-white border-b px-2 h-16 flex items-center">
